# Функция bool() возвращает одно из двух значений, в зависимости от входного значения.
# У "логики" есть несколько полезных особенностей, которые облегчают разработку.
